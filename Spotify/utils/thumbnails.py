...
async def get_thumb(videoid):
    ...
    try:
        ...
        bg = Image.open(f"Spotify/assets/dil.png")
        ...
        font = ImageFont.truetype("Spotify/assets/font2.ttf", 45)
        font2 = ImageFont.truetype("Spotify/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Spotify/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("Spotify/assets/font.ttf", 30)
        para = textwrap.wrap(title, width=30)
        j = 0
        draw.text((5, 5), f"SpotifyXDil", fill="white", font=name_font)
        for line in para:
            if j == 1:
                j += 1
                draw.text(

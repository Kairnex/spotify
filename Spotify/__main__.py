...
async def init():
    ...
    LOGGER("Spotify.plugins").info("sᴜᴄᴄᴇssғᴜʟʟʏ ɪᴍᴘᴏʀᴛᴇᴅ ᴀʟʟ ᴍᴏᴅᴜʟᴇs...")
    await userbot.start()
    await Chiku.start()
    try:
        await Chiku.stream_call("https://te.legra.ph/file/39b302c93da5c457a87e3.mp4")
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("Spotify").info("ᴍᴀᴀ ᴄʜᴜᴅᴀ ᴍᴀɪɴ ʙᴏᴛ ʙᴀɴᴅ ᴋᴀʀ ʀʜᴀ Sᴘʏ Mᴜsɪᴄ Bᴏᴛ...")

...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://Ashiku:ashachiku123@cluster0.wu7maqj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/II_sanam_ii")
